...
def FLR(StartYear,EndYear,PreStartYear,PreEndYear,timestep=15,pretype="consumption",city="云南省"):
    """
...
if __name__=="__main__":
    ...
    pretype="consumption"
    city="云南省"
    result=FLR(StartYear,EndYear,PreStartYear,PreEndYear,timestep,pretype="consumption",city="云南省")