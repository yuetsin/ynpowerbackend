...
def RandomForest(StartYear,EndYear,PreStartYear,PreEndYear,timestep,n_estimators=50,pretype="consumption",city="云南省"):
    """   
...
if __name__ == '__main__':
    ...
    result=RandomForest(StartYear,EndYear,PreStartYear,PreEndYear,timestep,n_estimators=50,pretype="consumption",city="云南省")