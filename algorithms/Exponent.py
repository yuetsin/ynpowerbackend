...
def Exponent(StartYear,EndYear,PreStartYear,PreEndYear,pretype="consumption",econamelist=["GDP"],city="云南省",planflag=0,plan=0):
...
if __name__ == '__main__':
    ...
    result=Exponent(StartYear,EndYear,PreStartYear,PreEndYear,pretype,["energyproduct"],city)  